// Generated via https://github.ibm.com/managed-security/generator-devsecops/blob/master/C:\Users\ManojRamasamy\AppData\Roaming\npm\node_modules\@mss\generator-devsecops\generators\categories\scaffold\core\nodejs-microservice\index.js
...
pipeline {
  ...
  stages {
    ...
    stage('Install') {
      steps {
        sh 'npm prune && npm ci && cd client && npm install'
      }
    }
    ...
    stage('Build') {
      steps {
        sh 'cd client && npm run build && ls -lrth && pwd'
      }
    }
